      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Silahkan daftar sebagai murid</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <form method="POST" action="{{ route('daftar.post') }}">
                ...
                <div class="text-center">
                    <p class="mt-3">Sudah punya akun? <a href="{{ route('login') }}" class="text-dark font-weight-bold">Masuk</a></p>
                </div>

                <!-- Hidden Field for Role -->
                <input type="hidden" class="form-control" name="role" value="murid">
            </form>

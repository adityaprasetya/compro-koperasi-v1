                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="https://via.placeholder.com/150" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                          </div>
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">B. Indonesia</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">Belum</span>
                      </td>
                      <td class="align-middle text-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="https://via.placeholder.com/150" class="avatar avatar-sm rounded-circle me-2" alt="invision">
                          </div>
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">B.Inggris</h6>
                          </div>
                        </div>
                      </td>
                      <td>
